...
DEFAULTS = {
    'EDITION': 'SELF_HOSTED',
    'DB_USERNAME': 'yydbuser',
    'DB_PASSWORD': 'YYDev@1030_',
    'DB_HOST': 'localhost',
    'DB_PORT': '5432',
    'DB_DATABASE': 'datasets',
    'DB_CHARSET': '',
    'DB_SCHEMA': 'public',
    ...
    'CODE_EXECUTION_END_POINT': 'http://sandbox:8194',
    ...
    'SECRET_KEY': '1',
    'JOURNAL_NUMBER': 1,
    'PAPER_ADVANCE_SEARCH_URL': 'https://datacenter.aminer.cn/gateway/open_platform/api/v3/paper/list/by/publish/pro',
    'PAPER_ADVANCE_SEARCH_URL_back': 'https://datacenter.aminer.cn/gateway/open_platform/api/v3/paper/list/by/publish/pro?venue=VENUE&page=PAGE_NUMBER&size=SIZE_NUMBER&order=year',
    'AMINER_PAPER_DETAIL_URL': 'https://datacenter.aminer.cn/gateway/open_platform/api/v3/paper/platform/details/not/contain/wos/by/id',
    'CROSSREF_PAPER_DETAIL_URL': 'https://api.crossref.org/works/DOI',
    'AMINER_TOKEN': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjMwMjg3NTEsInRpbWVzdGFtcCI6MTcyMDQzNjc1MSwidXNlcl9pZCI6IjY2OGJjNzcyZGEyODA5Y2M4MDk1NmU1MCJ9.eycK3GNLkGe8nYK0fRRhKcxciUoh14V_kTqw-whmcsQ',
    'PAPER_ADVANCE_SEARCH_SIZE': 10,
    'PAPER_ADVANCE_SEARCH_PAGE': 0,
}
...
class Config:
    ...
    def __init__(self):
        ...
        # ------------------------
        self.PAPER_ADVANCE_SEARCH_URL = get_env('PAPER_ADVANCE_SEARCH_URL')
        self.PAPER_ADVANCE_SEARCH_SIZE = get_env('PAPER_ADVANCE_SEARCH_SIZE')
        self.PAPER_ADVANCE_SEARCH_PAGE = get_env('PAPER_ADVANCE_SEARCH_PAGE')
        self.AMINER_PAPER_DETAIL_URL = get_env('AMINER_PAPER_DETAIL_URL')
        self.CROSSREF_PAPER_DETAIL_URL = get_env('CROSSREF_PAPER_DETAIL_URL')
        self.AMINER_TOKEN = get_env('AMINER_TOKEN')
        ...
        self.JOURNAL_NUMBER = get_env('JOURNAL_NUMBER')
        ...
        db_credentials = {
            ...
            ['DB_USERNAME', 'DB_PASSWORD', 'DB_HOST', 'DB_PORT', 'DB_DATABASE', 'DB_CHARSET', 'DB_SCHEMA']
        }
        ...
        escaped_username = quote(db_credentials['DB_USERNAME'])
        escaped_password = quote(db_credentials['DB_PASSWORD'])

        self.SQLALCHEMY_DATABASE_URI = (f"{self.SQLALCHEMY_DATABASE_URI_SCHEME}://{escaped_username}:{escaped_password}"
                                        f"@{db_credentials['DB_HOST']}:{db_credentials['DB_PORT']}/{db_credentials['DB_DATABASE']}{db_extras}"
                                        f"?options=-csearch_path%3D{db_credentials['DB_SCHEMA']}"                                        )
        ...
        # OSS
        # ------------------------
        self.BUCKET_NAME = get_env('BUCKET_NAME')
        self.END_POINT = get_env('END_POINT')
        self.OSS_ACCESS_KEY_ID = get_env('OSS_ACCESS_KEY_ID')
        self.OSS_ACCESS_KEY_SECRET = get_env('OSS_ACCESS_KEY_SECRET')
        ...
        self.S3_END_POINT = get_env('S3_END_POINT')
        ...
        self.ALIYUN_OSS_END_POINT=get_env('ALIYUN_OSS_END_POINT')
        ...
        # weaviate settings
        self.WEAVIATE_END_POINT = get_env('WEAVIATE_END_POINT')
        ...
        self.CODE_EXECUTION_END_POINT = get_env('CODE_EXECUTION_END_POINT')
